        ...
        this.scheduleOnce(function () {
            if (childBall.indexOf("rn") > -1) {//red ball
                if (this.redInList.indexOf(childBall) > -1)// already in
                {
                    ...
                    if (cc.find("Canvas/GameCore/" + parentBall + "/" + childBall).y >= 65) {
                        ...
                        this.redCheckList.splice(this.redCheckList.indexOf(childBall), 1);
                    }
                }
            }
            if (childBall.indexOf("bn") > -1) {//blue ball
                if (this.blueInList.indexOf(childBall) > -1)// already in
                {
                    ...
                    if (cc.find("Canvas/GameCore/" + parentBall + "/" + childBall).y <= - 65) {
                        ...
                        this.blueCheckList.splice(this.blueCheckList.indexOf(childBall), 1);
                    }
                }
            }
        }, 3)
