...
cc.Class({
    ...
    GetCache() {
        ...
        console.log("Geting HistoryScore:" + hScore);
        console.log("Geting LockedGames:" + lockStr);
    ...
    SaveCache() {
        if (CC_WECHATGAME) {
            console.log("Saving HistoryScore:" + this.CopHistoryScore);
            console.log("Saving LockedGames:" + this.LockedGames);
            wx.setStorage({
                key: "CopHistoryScore",
