declare class MainMenu extends eui.Skin{
}
declare class PushGameSceneSkin extends eui.Skin{
}
declare class ShiguanGameSceneSkin extends eui.Skin{
}
...
declare class CountDownUtilitySkin extends eui.Skin{
}
declare module skins{
